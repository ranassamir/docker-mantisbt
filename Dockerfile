...
ENV TESTLINK_VER 2.6.0 
ENV TESTLINK_MD5 b37ab5fa125e919d86734d349ad87c51 
ENV TESTLINK_URL https://ufpr.dl.sourceforge.net/project/mantisbt/mantis-stable/${MANTIS_VER}/mantisbt-${MANTIS_VER}.tar.gz
ENV TESTLINK_FILE mantisbt.tar.gz 
RUN set -xe \
